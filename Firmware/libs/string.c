...
char *strncpy(char *dest, const char *src, size_tt n)
{
  char *d = dest;
...
char *strncat(char *dest, const char *src, size_tt n)
{
  char *d = dest;
...
int strncmp(const char *s1, const char *s2, size_tt n)
{
	if (n == 0)
		return 0;
...
void *memmove(void *dest, void *src, size_tt n)
{
  char *d = dest;
  char *s = src;
...
int memcmp(const void *s1, const void *s2, size_tt n)
{
  char *p1 = (void *)s1;
  char *p2 = (void *)s2;
...
void *memchr(const void *s, int c, size_tt n)
{
  char *p = (void *)s;
